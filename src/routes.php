        ...
        $this->group("/kissj", function () use ($helper) {
            ...
            $this->group("", function () use ($helper) {
                ...
                */
                ...
                $this->get("/login/{token}[/{eventSlug}]",
            ...
            $this->get("/registration/{eventSlug}/{role}",
                function (Request $request, Response $response, array $args) {
                    $role = $args['role'];
                    if (!$this->roleService->isUserRoleNameValid($role)) {
                        throw new Exception('User role "'.$role.'" is not valid');
            ...
            $this->group("", function () use ($helper) {
                ...
                */
                ...
                $this->group("/patrol", function () {
                    ...
                    $this->get("/participant/{participantId}/showDetails",
                        function (Request $request, Response $response, array $args) {
                        ...
                        })->setName('p-showDetails')->add(function (
                        Request $request,
                        Response $response,
                        callable $next
                    ) {
                    ...
                    $this->group("", function () {
                        ...
                        $this->post("/confirmCloseRegistration",
                            function (Request $request, Response $response, array $args) {
                                $patrolLeader = $this->patrolService->getPatrolLeader($request->getAttribute('user'));
                ...
                */
                ...
                $this->group("/admin", function () {
                    ...
                    $this->group("/payments", function () {
                        ...
                        $this->post("/setPaymentPaid/{payment}",
                            function (Request $request, Response $response, array $args) {
