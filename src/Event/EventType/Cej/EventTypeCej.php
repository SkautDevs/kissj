...
class EventTypeCej extends EventType
{
    ...
    {
        return parent::getPrice($participant); // TODO: Change the autogenerated stub
    }
    ...
    public function getMaximumClosedParticipants(Participant $participant): int
    {
        if ($participant instanceof PatrolLeader) {
            return match ($participant->contingent) {
                'detail.contingent.czechia' => 40,
                'detail.contingent.slovakia' => 20,
                'detail.contingent.poland' => 40,
                'detail.contingent.hungary' => 20,
                'detail.contingent.european' => 30,
                default => 0,
            };
        }
