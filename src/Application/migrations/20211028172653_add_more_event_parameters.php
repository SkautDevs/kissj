...
final class AddMoreEventParameters extends AbstractMigration
{
    public function up(): void
    {
        $this->query('ALTER TABLE `event`
	        ADD `default_price` INTEGER NOT NULL DEFAULT 0;');
        
        $this->query('ALTER TABLE `event`
	        ADD `event_type` TEXT DEFAULT "default" NOT NULL;');
        
        $this->query('ALTER TABLE `event`
	        ADD `logo_url` TEXT DEFAULT "" NOT NULL;');
    }

    public function down(): void
    {
        $this->query('CREATE TABLE `event_dg_tmp`
    (
        id INTEGER
