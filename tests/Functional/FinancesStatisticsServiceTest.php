...
class FinancesStatisticsServiceTest extends AppTestCase
{
    public function testMonthlySumsWaitingTotalAndUnknownBucketForPlainEvent(): void
    {
        ...
        $this->createFinancesPayment($app, $event, PaymentStatus::Paid, '450');
        ...
        self::assertInstanceOf(FinancesReport::class, $report);
        self::assertSame(
            ['2026-06', '2026-05', FinancesStatisticsService::MONTH_UNKNOWN],
    ...
    public function testKorboScarvesAndTiers(): void
    {
        ...
        $this->createFinancesPayment($app, $event, PaymentStatus::Paid, '500', '2026-06-03', 'Kč', Participant::SCARF_YES);
        ...
        self::assertSame([
            ...
            static fn (FinanceTierStat $stat): array => [
                'price' => $stat->tier instanceof FinanceTier ? $stat->tier->price : null,
                'scarf' => $stat->tier instanceof ScarfFinanceTier ? $stat->tier->scarf : null,
    ...
    public function testKorboTiersOmitOtherRowWhenNoOffTierPayments(): void
    {
        ...
        foreach ($report->tiers as $stat) {
            self::assertNotInstanceOf(FinanceTierUnknown::class, $stat->tier);
        }
    }
}
